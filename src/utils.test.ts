...
describe('Dashboard Summaries & Waive Charge', () => {
  ...
  it('Manager Approval: status approved correctly increments Realized Gain in metrics', () => {
    const txs = [
      { id: '1', amount: 5000, status: 'approved', approvalStatus: 'approved', approved: true, profit: 350, timestamp: new Date().toISOString() },
      { id: '2', amount: 10000, status: 'Success', profit: 200, timestamp: new Date().toISOString() }
    ] as any;
